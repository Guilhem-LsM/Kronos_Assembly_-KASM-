...
static const char* ERROR_TYPE_STRING[19] =
{
    ...
    "_NEGATIVE_INSTRUCTION_ADRESS_", // Negative line adress entered
    "_INSTRUCTION_ADRESS_TOO_FAR_" // The instruction you tried to reach does not exist
};
