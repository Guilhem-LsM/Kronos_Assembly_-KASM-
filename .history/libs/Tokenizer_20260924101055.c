...
struct token* tokenize(char* raw_program){
    ...
    {   
        ...
        {
            error(_INVALID_CHAR_, line, char_, (int)*char_pointer, "");
        }
        ...
        if(is_char_in_array(*char_pointer, SEPARATION_CHARS, SEPARATION_CHAR_NUMBER)) // If the char is a separator
        {
            ...
            {   
                ...
                else if(is_only_number_in_string(lexeme+1)) // Check if the lexeme is an adress
                {
                    ...
                    default:
                        error(_INVALID_PREFIX_, line, char_, (int)lexeme[0], "");
                        break;
                    }
                ...
                {   
                    ...
                    {
                        error(_INVALID_KEYWORD_, line, char_, 0, lexeme);
                    }
            ...
            else
            {
                if(*char_pointer == '*')
                {
                    error(_UNEXPECTED_AST_, line, char_, 0, "");
                }
            }
        ...
        {   
            ...
            {
                error(_LEXEME_TOO_LONG_, line, char_, 0, "");
            }
