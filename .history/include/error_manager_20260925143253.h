...
enum error_type 
{
    ...
    _VALUE_OUT_OF_RANGE_, // The value entered is not within the correct range
    _ADRESS_OUT_OF_RANGE_, // The adress entered is not within the correct range
    _NEGATIVE_INSTRUCTION_INDEX_, // Negative line adress entered
